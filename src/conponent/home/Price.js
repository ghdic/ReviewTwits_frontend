  ...
  return (
    <PriceStyled>
        ...
        <div className="container">
            <WeirdCard icon_name="earth-outline" title="Plus Plan" price="$11 per month" color="linear-gradient(to bottom,#2200ff,#14fbf6)" content={['하루 최대 50,000페이지 뷰', 'Ad-Free', '3개 프로젝트 생성가능']} />
